...
import { ArrowRightStartOnRectangleIcon } from '@heroicons/react/24/outline'; // Import the icon
import KanbanZenLogo from '../public/KanbanZen-logo.svg';
    ...
    return (
        <header>
            <div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl">
                ...
                />
                <KanbanZenLogo
                    alt="KanbanZen Banner"
                    width={350}
                    height={100}
                    className="w-50 md:w-56 -pb-2 md:pb-0 object-contain"
                />
